...
/* USER CODE BEGIN PV */
uint8_t button_prev = GPIO_PIN_SET;   // Store old button state

uint32_t last_time = 0;               // Store last press time
uint32_t press_count = 0;             // Number of valid presses
